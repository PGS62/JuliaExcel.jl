 ...
 * Launch Julia, and copy-paste the following command into the REPL:  
   `using Pkg; Pkg.add(url="https://github.com/PGS62/JuliaExcel.jl",rev="0.2.4");using JuliaExcel;JuliaExcel.installme()`  
 ...
 *  JuliaExcel does not work if Windows Terminal is installed. See [this issue](https://github.com/PGS62/JuliaExcel.jl/issues/9).
