...
10            Case 9: GetAt = Arr(Idx(1), Idx(2), Idx(3), Idx(4), Idx(5), Idx(6), Idx(7), Idx(8), Idx(9))
11            Case Else
12                Throw "Rank > 9 not supported"
13        End Select

14        Exit Function
ErrHandler:
15        ReThrow "GetAt", Err
End Function
...
10            Case 9: Arr(Idx(1), Idx(2), Idx(3), Idx(4), Idx(5), Idx(6), Idx(7), Idx(8), Idx(9)) = Value
11            Case Else
12                Throw "Rank > 9 not supported"
13        End Select
