...
' Purpose    : Thin wrapper around SolumAddin.xlam's SaveWorkbookAndExportForGit, callable via Application.Run
...
'              SaveWorkbookAndExportForGit is SaveAddInAndExportVBA's successor and, unlike its predecessor,
'              works for both .xlam add-ins and ordinary .xlsm workbooks.
' -----------------------------------------------------------------------------------------------------------------------
Public Function CallSaveAddInAndExportVBA() As String
1         On Error GoTo ErrHandler
2         ThrowIfError Application.Run("'SolumAddin.xlam'!SaveWorkbookAndExportForGit", ThisWorkbook, True)
